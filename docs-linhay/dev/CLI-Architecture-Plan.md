...
关联需求：`docs-linhay/features/CLI-Benchmark-Spec.md`
ACP WebSocket 规格：`docs-linhay/features/ACP-WebSocket-Serve-Spec.md`
...
- 关联需求：`docs-linhay/features/ACP-Agent-Telemetry-Spec.md`
...
- 关联需求：`docs-linhay/features/ACP-Protocol-Extension-Boundaries.md`
...
- 关联需求：`docs-linhay/features/ACP-WebSocket-Serve-Spec.md`
...
- 运维文档：
  - `docs-linhay/plans/ops/ACP-WebSocket-Test-Stability-Runbook.md`
- 验证：
...
- 关联需求：`docs-linhay/features/ACP-WebSocket-Serve-Spec.md` 场景 63/64
