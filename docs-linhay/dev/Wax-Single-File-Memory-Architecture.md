...
本报告基于 `docs-linhay/references/Wax` 源码，聚焦四个问题：
...
参考：
- `docs-linhay/references/Wax/Sources/WaxCore/WaxCore.docc/Articles/FileFormat.md`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxCore/Wax.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxCore/WaxCore.docc/Articles/WALAndCrashRecovery.md`
- `docs-linhay/references/Wax/Sources/WaxCore/WAL/WALRingWriter.swift`
- `docs-linhay/references/Wax/Sources/WaxCore/WAL/WALRingReader.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxCore/Wax.swift`
- `docs-linhay/references/Wax/Sources/WaxCore/FileFormat/FooterScanner.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxTextSearch/FTS5SearchEngine.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxVectorSearch/USearchVectorEngine.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearch/MetalVectorEngine.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearch/VectorSerializer.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/Wax/UnifiedSearch/UnifiedSearch.swift`
- `docs-linhay/references/Wax/Sources/Wax/UnifiedSearch/HybridSearch.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/Wax/Orchestrator/MemoryOrchestrator.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/MiniLMEmbedder.swift`
- `docs-linhay/references/Wax/Sources/WaxMCPServer/main.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxCore/IO/FileLock.swift`
- `docs-linhay/references/Wax/Sources/WaxCore/Wax.swift`
...
参考：
- `docs-linhay/references/Wax/Package.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/Wax/Adapters/MemoryOrchestrator+MiniLM.swift`
...
参考：
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/CoreML/MiniLMEmbeddings.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/CoreML/all-MiniLM-L6-v2.swift`
...
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/MiniLMEmbedder.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/CoreML/MiniLMEmbeddings.swift`
- `docs-linhay/references/Wax/Sources/WaxVectorSearchMiniLM/CoreML/BertTokenizer.swift`
