...
- 关联规格：`docs-linhay/features/ACP-WebSocket-Serve-Spec.md` 场景 33-36、40-41。
...
- 参考规格：`docs-linhay/features/ACP-WebSocket-Serve-Spec.md`
- 状态说明：`已覆盖` / `部分覆盖` / `待补充`
...
- 新增覆盖矩阵文档：`docs-linhay/dev/ACP-Spec-Coverage-Matrix.md`（spec 场景到测试映射）。
