...
4. 更新 BDD 规格：
   - `docs-linhay/features/CLI-Benchmark-Spec.md` 增加“stdio 子进程命令支持 PATH 解析”场景。
...
3. 更新 BDD 规格：
   - `docs-linhay/features/CLI-Benchmark-Spec.md` 增加 “help 明确 --cmd 的 PATH 语义” 场景。
...
3. 更新 BDD 规格：
   - `docs-linhay/features/CLI-Benchmark-Spec.md` 增加 “help 说明 --args 的 option-like 传参规则” 场景。
