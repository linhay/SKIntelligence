...
4. VLM/image workflows:
   ...
   - Verify E2E via `docs-linhay/plans/ops/MLX-E2E-Runbook.md`.
...
gh release create 2.0.0 \
  ...
  --notes-file docs-linhay/plans/ops/Release-2.0.0.md
```
...
- `docs-linhay/plans/ops/CI-AutoTag.md`
- `docs-linhay/plans/ops/Release-2.0.0-GitHub-Short.md`
- `docs-linhay/plans/ops/Release-2.0.0-GitHub-Full.md`
