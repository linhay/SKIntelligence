...
- 同步修复 `README.md` 与 `docs-linhay/dev/Getting-Started.md` 中的文档链接。
...
## 23:22 CLI 文档基线
- 新增需求规格：`docs-linhay/features/CLI-Benchmark-Spec.md`
- 新增技术方案：`docs-linhay/dev/CLI-Architecture-Plan.md`
