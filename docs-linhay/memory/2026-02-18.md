...
- 文档：`docs-linhay/features/CLI-Benchmark-Spec.md` 新增 PATH 解析验收场景；`docs-linhay/dev/Codex-CLI-Experience-Report.md` 新增 Round 16。
...
- 实施：
  ...
  - 更新 `docs-linhay/features/CLI-Benchmark-Spec.md` 场景 13。
- 验证：
  - 定向测试通过；
...
- 实施：
  ...
  - `docs-linhay/features/CLI-Benchmark-Spec.md` 新增场景 14。
- 验证：
  - 定向测试通过；
