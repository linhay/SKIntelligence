...
//
    ...
    public struct SKIToolQueryCalendar: SKITool {
        ...
        public var shortDescription: String =
            "Query calendar events from the user's system calendars for a specific date or date range."
        ...
        public struct Event: Codable {
            ...
            @SchemaOptions(
                .description(
                    "The start date of the event in ISO 8601 format (YYYY-MM-DDTHH:mm:ssZ)."))
            public let startDate: String
            @SchemaOptions(
                .description("The end date of the event in ISO 8601 format (YYYY-MM-DDTHH:mm:ssZ).")
            )
        ...
        public func call(_ arguments: Arguments) async throws -> ToolOutput {
            ...
            if try await store.requestFullAccessToEvents(),
                ...
                let endDate = arguments.end_date.isEmpty
                    ? nil : formatter.date(from: arguments.end_date)
            {
