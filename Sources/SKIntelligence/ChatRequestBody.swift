...
public struct ChatRequestBody: Sendable, Encodable {
    ...
    /// If set, partial message deltas will be sent. Using the `ChatService.streamingChatCompletionRequest`
...
public extension ChatRequestBody {
    ...
    enum ResponseFormat: Sendable, Encodable {
        ...
        private enum RootKey: String, Sendable, CodingKey {
            case type
        }
...
public extension ChatRequestBody {
    /// Controls which (if any) tool is called by the model.
    enum ToolChoice: Sendable, Encodable {
