...
## Codex Skills 机制沉淀
- 决策：将 openai/codex 长期沉淀到 references/openai-codex（commit: 6a673e7），不再仅放 /tmp。
- 产出：新增分析文档 references/docs/dev/openai-codex-skills-implementation-analysis.md，覆盖 skills 的发现、加载、触发、注入、依赖与协议实现。
